...
| #4 M3 书源协议 | 已满足当前验收边界 | `docs/source-protocol.md`、兼容性矩阵和本机合成夹具覆盖统一模型、解析、超时/大小/错误边界；CI 31574147034 通过 | 已评论并关闭 |
...
当前不能把五个 issue 全部关闭。#4、#5 可以在本审计评论后已执行；#1–#3 保持 open，直到各自剩余的治理或目标 Windows 验收有可追溯记录。
