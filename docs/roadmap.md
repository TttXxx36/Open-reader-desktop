...
- M9.3 查询/单本编辑首切片与批量元数据首切片均已完成：分组、标签、筛选、排序、单本编辑、多选和批量分组/标签更新，main CI run [31385269180](https://github.com/TttXxx36/Open-reader-desktop/actions/runs/31385269180)、[31388184266](https://github.com/TttXxx36/Open-reader-desktop/actions/runs/31388184266) 通过；Windows Release/installer smoke run [31388689695](https://github.com/TttXxx36/Open-reader-desktop/actions/runs/31388689695)、[31389443472](https://github.com/TttXxx36/Open-reader-desktop/actions/runs/31389443472) 通过。后续补充封面缓存策略和重复书合并。
