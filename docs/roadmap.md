...
- M9.3 首切片（分组、标签、筛选、排序、单本元数据编辑）已完成，main CI run [31385269180](https://github.com/TttXxx36/Open-reader-desktop/actions/runs/31385269180) 通过；后续补充批量操作、封面缓存策略和重复书合并。
